...
⚠️ **WARNING** ⚠️ Please try to bet with the lowest amount so you don't run out of balance before you even start. Please note that on every bet there's 15% fee. If you want to remove this, contact me (`0000@disroot.org`).
